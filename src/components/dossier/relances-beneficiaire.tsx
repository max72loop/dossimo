  ...
  return <section className="mb-6 rounded border border-filigrane bg-blanc-casse p-5 shadow-sm">
    <div className="flex flex-wrap items-start justify-between gap-3">
      ...
      {!etat.desinscrit && (etat.active
        ...
        : <button type="button" disabled={busy} onClick={() => basculer(true)} className="rounded bg-terre-cuite px-3 py-1.5 text-xs font-medium text-blanc-casse">Activer les relances</button>)}
    </div>
