...
import { generateAndSaveQuote } from "@/lib/quotes/actions";
...
export function QuoteLibrary({ gestures, fields }: { gestures: Gesture[]; fields: Field[] }) {
