          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-4">
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-sm text-ardoise">
                ...
                <li><Link href="/visite" className="transition-colors hover:text-encre">Visite guidée</Link></li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5 text-sm text-ardoise">
                ...
                <li><Link href="/refus" className="transition-colors hover:text-encre">Dossier refusé ?</Link></li>
