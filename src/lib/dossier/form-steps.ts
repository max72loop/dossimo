...
export const ETAPES_DOSSIER: { id: EtapeDossierId; titre: string; champs: ChampDossier[] }[] = [
  ...
  // `date_offre_cee` et `offre_cee_anterieure` manquaient à cette liste, alors que
  // la première porte le motif de refus CEE n° 1. Un champ absent d'ici est
  // invisible à `etapesPourSaisie` : en saisie assistée, l'étape peut être jugée
  // complète et sautée sans que la question ait jamais été posée.
  { id: "dates", titre: "Dates & montants", champs: ["date_offre_cee", "offre_cee_anterieure", "date_visite_technique", "date_devis", "date_debut_travaux", "date_fin_travaux", "date_facture", "facture_reference", "montant_ht", "montant_ttc", "montant_prime_estime", "montant_aides_publiques"] },
];
